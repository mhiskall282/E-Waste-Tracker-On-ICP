          ...
          <div className="p-4 bg-white border-t border-gray-200">
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="bg-gradient-to-r from-purple-500 to-indigo-500 hover:opacity-90 text-white px-4 py-2 rounded-lg transition-all duration-300 disabled:opacity-50"
              >
